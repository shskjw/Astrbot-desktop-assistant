...
class SettingsController(QObject):
    ...
    def _update_hotkey_settings(self, hotkeys: Dict[str, Any]) -> None:
        ...
        for key in ['toggle_chat', 'region_screenshot', 'full_screenshot', 
                    'toggle_ball', 'quick_ask', 'cycle_theme']:
            if key in hotkeys:
        ...
        if 'chat_history_path' in storage:
            ...
            if self._chat_history_manager:
                try:
                    ...
                    print("[DEBUG] ChatHistoryManager 路径已同步更新")
